...
def migrate_quest_tables():
    ...
    try:
        with db.get_cursor() as cur:
            ...
            if not quest_row:
                raise RuntimeError('Default quest could not be created')

            quest_id = quest_row[0]

            steps = [
                (1, 'Submit Application', 'Register on the UAIC portal, upload documents, and pay the application fee.', 'March 31', '2026-03-31', 'UAIC Admissions and Programs', 'https://www.uaic.ro/en/admission/'),
                (2, 'Wait & Track', 'Monitor your email and reply quickly if the admission office requests more information.', 'May 15', '2026-05-15', 'UAIC International Relations Department', 'https://www.uaic.ro/en/international/departamentul-de-relatii-internationale/'),
                (3, 'Receive Offer', 'Accept or reject the offer and confirm enrollment once the result arrives.', 'June 1', '2026-06-01', 'UAIC Admissions and Programs', 'https://www.uaic.ro/en/admission/'),
                (4, 'Housing Application', 'Apply for dorm housing early and keep a private housing backup ready.', 'July 1', '2026-07-01', 'UAIC Student Housing Services', 'https://www.uaic.ro/en/student-services/accommodation'),
                (5, 'Pre-Arrival', 'Book transport, prepare your bank account plan, and get your arrival essentials ready.', 'August 15', '2026-08-15', 'Romanian Immigration Office (IGI)', 'https://igi.mai.gov.ro/'),
            ]
