...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.student_type) {
      setLocalError(
        "Please select whether you are an Erasmus or International student",
      );
      return;
    }
    ...
    const faculty = IASI_FACULTIES.find(
      (f) => f.id === formData.target_faculty_id,
    );
    ...
    const result = await register(
      ...
      formData.fullName,
      {
        ...
        target_university: normalizeUniversityId(
          faculty?.university || formData.target_university,
        ),
        target_faculty: faculty?.name || "",
        target_faculty_id: formData.target_faculty_id,
        study_program: formData.target_program,
        home_university:
          formData.student_type === "erasmus" ? formData.home_university : "",
        home_faculty:
          formData.student_type === "erasmus" ? formData.home_faculty : "",
        academic_year:
          formData.student_type === "erasmus" ? formData.academic_year : "",
      },
    );
  ...
  const availableProgramOptions = formData.target_faculty_id
    ? getProgramOptionsByFaculty(formData.target_faculty_id)
    : [];
  ...
  return (
    <div className="nv-auth-screen">
      <div className="nv-login-left">
          ...
          {[1, 2].map((s) => (
            <div
              ...
              style={{
                ...
                borderRadius: 2,
                background:
                  step >= s ? "var(--sage)" : "rgba(255,255,255,0.25)",
        ...
        <p
          style={{ marginTop: 8, fontSize: 13, color: "rgba(255,255,255,0.7)" }}
        >
          Step {step} of 2 —{" "}
          {step === 1 ? "Account details" : "Your academic profile"}
        </p>
      </div>
        ...
        {step === 1 ? (
          <>
            ...
            <form onSubmit={handleNext} style={{ width: "100%" }}>
              ...
              <button type="submit" className="nv-btn-login">
                Continue →
              </button>
            </form>
          ...
          <>
            ...
            <p className="nv-login-form-sub">
              This helps NaviRo personalise guidance just for you
            </p>
            ...
            <form onSubmit={handleSubmit} style={{ width: "100%" }}>
                ...
                >
                  {STUDENT_TYPES.map((t) => (
                    <button
                      ...
                      type="button"
                      onClick={() =>
                        setFormData((prev) => ({ ...prev, student_type: t.id }))
                      }
                      style={{
                        display: "flex",
                    ...
                    >
                      <span style={{ fontSize: 24, lineHeight: 1.2 }}>
                        {t.icon}
                      </span>
                      <div>
                        <div
              ...
              {formData.student_type === "erasmus" && (
                <>
                  ...
                  <div className="nv-form-group">
                    <label htmlFor="home_faculty">
                      Faculty / Department at home university
                    </label>
                    <div className="nv-input-wrap">
                      <GraduationCap size={16} />
                      <input
                  ...
                  <div className="nv-form-group">
                    <label htmlFor="academic_year">
                      Current academic year at home university
                    </label>
                    <select
                      id="academic_year"
                      name="academic_year"
